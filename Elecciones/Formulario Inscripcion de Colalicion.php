...
function idmunicipio(){
  ...
  .der{border-radius:0 10px 10px 0;}
	...
	<body>
		...
		<form action="manejadorinscripcionCoa.php?accion=save" method="POST"  id="formulario" enctype="multipart/form-data" class="box login">
    ...
    <table bordercolor="yellow" >
        ...
        ?>
                  ...
                  <td width="172px" height="32px"> <label>Municipio</label><br><output id="municipios" > </output></td>
                </tr>
      ...
      <?php 
        ...
        ?>
              ...
              <td>
                ...
                <tr>
                <td><label>Nombre de la coalicion</label></td>
                  <td> <input type="text" name="Nombrecoalicion"></td>
                </tr>
              </tr>
<td>

<input type="submit" class="submit" value="Guardar coalicion" name="coalicion" onclick="valida()"></td>
